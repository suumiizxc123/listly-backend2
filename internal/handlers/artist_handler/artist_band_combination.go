...
func CreateArtistBandCombination(c *gin.Context) {
	var artistSong artist.ArtistBandCombination
...
func GetArtistBandCombinationList(c *gin.Context) {
	var artistSong artist.ArtistBandCombination
...
func UpdateArtistBandCombination(c *gin.Context) {
	var artistSong artist.ArtistBandCombination
...
func DeleteArtistBandCombination(c *gin.Context) {
	var artistSong artist.ArtistBandCombination
	var err error
	id, ok := c.GetQuery("id")
...
func GetArtistBandCombination(c *gin.Context) {
	var artistSong artist.ArtistBandCombination
	var err error
	id, ok := c.GetQuery("id")
