...
func CreateSongLanguage(c *gin.Context) {
	var song song.SongLanguage
	var err error
...
func UpdateSongLanguage(c *gin.Context) {
	var song song.SongLanguage
	var err error
...
func GetSongLanguage(c *gin.Context) {
...
func DeleteSongLanguage(c *gin.Context) {
...
func GetSongLanguageList(c *gin.Context) {
	var song song.SongLanguage
