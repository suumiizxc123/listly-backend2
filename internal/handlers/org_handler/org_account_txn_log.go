...
func CreateOrgAccountTxnLog(c *gin.Context) {
	var org org.OrgAccountTxnLog
	var err error
...
func UpdateOrgAccountTxnLog(c *gin.Context) {
	var org org.OrgAccountTxnLog
	var err error
...
func DeleteOrgAccountTxnLog(c *gin.Context) {
	var org org.OrgUser
	var err error
...
func GetOrgAccountTxnLog(c *gin.Context) {
	var org org.OrgUser
	var err error
...
func GetOrgAccountTxnLogList(c *gin.Context) {
	var org org.OrgUser
	var err error
