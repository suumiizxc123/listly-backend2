...
func CreateOrgAccountTxn(c *gin.Context) {
	var org org.OrgAccountTxn
	var err error
...
func UpdateOrgAccountTxn(c *gin.Context) {
	var org org.OrgAccountTxn
	var err error
...
func DeleteOrgAccountTxn(c *gin.Context) {
	var org org.OrgAccountTxn
	var err error
...
func GetOrgAccountTxn(c *gin.Context) {
	var org org.OrgAccountTxn
	var err error
...
func GetOrgAccountTxnList(c *gin.Context) {
	var org org.OrgAccountTxn
	var err error
